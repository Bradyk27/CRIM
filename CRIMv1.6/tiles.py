...
class WizardRoom(MapTile):
    ...
    def intro_text(self,player):
        ...
        if not player.is_alive() and not self.key_taken:
            ...
            self.key_taken = True
            if player.keys > 1:
                return 'The wizard stares in shock as your cold, ghastly, dead body passes through his forcefield. Terrified, he hands you a blue key. Congratulations! You now have {} keys!'.format(player.keys)
            else:
                return 'The wizard stares in shock as your cold, ghastly, dead body passes through his forcefield. Terrified, he hands you a blue key. Congratulations! You now have {} key!'.format(player.keys)
        else:
